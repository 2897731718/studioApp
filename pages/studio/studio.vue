	...
	<view class="content">
		...
		<view class="flex align-center justify-center margin-top-lg related_box">
			...
			<view class="flex flex-wrap stu_infor">
				<navigator url="/pages/studio/introduction" class="stu_introduce  margin-bottom-sm margin-left-xl ">
					<view class="img_bac" style="background-image: linear-gradient(to right, #f78ca0 0%, #f9748f 19%, #fd868c 60%, #fe9a8b 100%);">
		...
		<view class="check_box margin-top-lg flex align-center justify-center">
			<view class="choose_title">
				<view class="condition_title" :class="index==menuIndex?'choosed':''" v-for="(item,index) in chooseTitle" :key="index" @click="chooseChange(index)">
					{{item}}
				</view>
			</view>
		</view>
		<!-- 考核卡片 -->
		<view class="check_area" @click="cardClick">
